      ...
      <footer>
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p><a href="#synopsis">{t('navAbout')}</a></p>
            <p><a href="#arsenal">{t('navSkills')}</a></p>
            <p><a href="#blueprint">{t('navExperience')}</a></p>
            <p><a href="#projects">{t('navProjects')}</a></p>
            <p><a href="/admin" className="text-gray-500 hover:text-[var(--accent-cyan)] transition-colors text-xs font-mono uppercase tracking-widest mt-4 inline-block">System Admin</a></p>
          </div>
          <div className="footer-section">
